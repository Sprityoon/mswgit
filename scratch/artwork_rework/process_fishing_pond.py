...
def process_image():
    src_path = r"C:\Users\윤민호\.gemini\antigravity-ide\brain\b9d055b5-25c8-4d77-9c02-ef350c679cf6\msw_topdown_fishing_pond_1784713780434.png"
    ...
    out_path_256 = os.path.join(out_dir, "msw_topdown_fishing_pond_256.png")
    ...
    out_path_128 = os.path.join(out_dir, "msw_topdown_fishing_pond_128.png")
