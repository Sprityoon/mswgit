...
def process_image():
    src_path = r"C:\Users\윤민호\.gemini\antigravity-ide\brain\b9d055b5-25c8-4d77-9c02-ef350c679cf6\msw_topdown_quest_board_1784715196392.png"
    ...
    out_path_256 = os.path.join(out_dir, "msw_topdown_quest_board_256.png")
    ...
    out_path_128 = os.path.join(out_dir, "msw_topdown_quest_board_128.png")
