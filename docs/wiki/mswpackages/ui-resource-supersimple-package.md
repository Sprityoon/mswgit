> **[미러]** 원문: [MSW-Git/MSWPackages/ui-resource-supersimple-package/README.md](https://github.com/MSW-Git/MSWPackages/tree/main/ui-resource-supersimple-package) @ `1609170` · 미러일 2026-07-23
> 이 파일은 원문 사본입니다 — 직접 수정하지 말 것. 프로젝트 관점 요약·적용 노트는 [INDEX.md](INDEX.md) 참조.

# UIResourcePack

This package is a UI resource pack collected from Getting Over It Maker, an original world.
